...
<body>
	...
	<section class="login-content">
		...
		<div class="login-box">
			<div class="col-md-12">
				...
				<hr>
				<div class="">
					<a class="semibold-text mb-2" href="<?=base_url('santri/login.php')?>"><i class="fa fa-angle-left fa-fw"></i> Use Data Login</a>
				</div>
			</div>
		</div>
	</section>
	...
	<script src="<?= base_url('santri/js/jquery.js'); ?>"></script>
	<script src="<?= base_url('santri/js/qrcodelib.js'); ?>"></script>
	<script src="<?= base_url('santri/js/webcodecamjquery.js'); ?>"></script>
